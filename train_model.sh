...
CUDA_VISIBLE_DEVICES=4,5,6,7 OMP_NUM_THREADS=32 nohup python -m src.main +experiment=re10k \
dataset.roots=[/data0/xxy/data/re10k] \
data_loader.train.batch_size=2 \
dataset.test_chunk_interval=100 \
...
CUDA_VISIBLE_DEVICES=3,4,5,7 OMP_NUM_THREADS=32 nohup python -m src.main +experiment=re10k \
dataset.roots=[/data0/xxy/data/re10k] \
data_loader.train.batch_size=2 \
dataset.test_chunk_interval=100 \
trainer.max_steps=50000 \
...
CUDA_VISIBLE_DEVICES=5,7 OMP_NUM_THREADS=32 nohup python -m src.main +experiment=re10k \
dataset.roots=[/data0/xxy/data/re10k] \
data_loader.train.batch_size=2 \
dataset.test_chunk_interval=100 \
...
optimizer.lr=1e-5 \
optimizer.lr_monodepth=1e-5 >gscube_depth22_gpc1_scale4_with_skip_small_continue 2>&1 &
