...
parser.add_argument('--index_path', type=str, default='/data0/xxy/code/CanonicalGS/assets/re10k_12v_canonical_len100_indicies.json')
...
if extra_args.model == 'depthsplat':
    overrides = [
        ...
        "dataset.test_chunk_interval=30",
